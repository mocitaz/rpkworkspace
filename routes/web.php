...
Route::middleware(['auth', EnsureUserIsActive::class, 'verified'])->group(function () {
    ...
    Route::patch('templates/{template}', [DocumentTemplateController::class, 'update'])->name('templates.update');
    Route::post('templates/{template}/duplicate', [DocumentTemplateController::class, 'duplicate'])->name('templates.duplicate');
    Route::post('templates/{template}/versions', [DocumentTemplateController::class, 'createVersion'])->name('templates.versions.store');
    ...
    Route::get('admin/audit', AuditLogController::class)->name('admin.audit.index');
