...
Route::get('verify/quotation/{quotationNumber}', [PublicVerificationController::class, 'verifyQuotation'])->name('verify.quotation');
Route::get('verify/quotation/{quotationNumber}/qr.svg', [PublicVerificationController::class, 'quotationQr'])->name('verify.quotation.qr');
Route::get('verify/payment-receipt/{referenceNumber}', [PublicVerificationController::class, 'verifyPaymentReceipt'])->name('verify.payment-receipt');
Route::get('verify/payment-receipt/{referenceNumber}/qr.svg', [PublicVerificationController::class, 'paymentReceiptQr'])->name('verify.payment-receipt.qr');
Route::get('verify/payslip/{payslipNumber}', [PublicVerificationController::class, 'verifyPayslip'])->name('verify.payslip');
Route::get('verify/payslip/{payslipNumber}/qr.svg', [PublicVerificationController::class, 'payslipQr'])->name('verify.payslip.qr');
...
Route::get('verify/conflict/{conflictCheck}', [PublicVerificationController::class, 'verifyConflictCertificate'])->name('verify.conflict-certificate');
Route::get('verify/conflict/{conflictCheck}/qr.svg', [PublicVerificationController::class, 'conflictCertificateQr'])->name('verify.conflict-certificate.qr');
Route::get('verify/matter-status/{matter}', [PublicVerificationController::class, 'verifyMatterStatus'])->name('verify.matter-status');
Route::get('verify/matter-status/{matter}/qr.svg', [PublicVerificationController::class, 'matterStatusQr'])->name('verify.matter-status.qr');
...
Route::middleware(['auth', EnsureUserIsActive::class, 'verified'])->group(function () {
    ...
    Route::put('matters/{matter}/events/{event}', [MatterOperationController::class, 'updateEvent'])->name('matters.events.update');
    ...
    Route::get('calendar/google/connect', [GoogleCalendarController::class, 'redirect'])->name('calendar.google.redirect');
    Route::get('calendar/google/callback', [GoogleCalendarController::class, 'callback'])->name('calendar.google.callback');
    Route::put('calendar/google/settings', [GoogleCalendarController::class, 'update'])->name('calendar.google.update');
    Route::post('calendar/google/sync', [GoogleCalendarController::class, 'sync'])->name('calendar.google.sync');
    Route::delete('calendar/google', [GoogleCalendarController::class, 'destroy'])->name('calendar.google.destroy');
    ...
    Route::put('finance/quotations/{quotation}', [FinanceController::class, 'updateQuotation'])->name('finance.quotations.update');
