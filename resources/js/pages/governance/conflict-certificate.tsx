...
export default function ConflictCertificate({
    ...
    return (
        <div className="min-h-screen bg-slate-100/70 py-6 text-slate-900 dark:bg-[#0c0d10] dark:text-slate-100 print:bg-white print:p-0">
            <Head
            ...
            <div className="mx-auto mb-6 flex max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8 print:hidden">
                <Button
                    variant="outline"
                    size="sm"
            ...
            <div className="mx-auto max-w-7xl rounded-2xl border border-slate-200/90 bg-white p-6 shadow-xl shadow-slate-200/60 sm:p-10 dark:border-white/10 dark:bg-[#14161b] dark:shadow-none print:m-0 print:max-w-none print:rounded-none print:border-none print:p-8 print:shadow-none">
                ...
                <div className="my-7 space-y-2 text-center">
                    <div className="inline-flex items-center gap-2 rounded-md bg-slate-900 px-3 py-1 font-mono text-[10px] font-bold tracking-wider text-white uppercase dark:bg-white dark:text-slate-900">
                        <FileCheck className="size-3 text-amber-400 dark:text-amber-600" />
                        NO. REGISTRASI KEPATUHAN: CC/
                    ...
                    <div className="mx-auto mt-4 max-w-2xl">
                        <div className="rounded-xl border border-slate-300/80 bg-slate-50/80 p-4 text-center shadow-xs sm:p-5 dark:border-white/10 dark:bg-[#121418]">
                            ...
                            <div className="mt-1 flex items-center justify-center gap-2">
                                <span className="font-serif text-base font-black tracking-tight text-slate-900 uppercase sm:text-lg dark:text-white">
                                    {isClear
                            ...
                            <p className="mt-1 text-[11.5px] font-medium text-slate-600 dark:text-zinc-400">
                                {isClear
                ...
                <div className="space-y-6 text-xs leading-relaxed text-slate-700 dark:text-zinc-300">
                    <p className="text-justify leading-relaxed">
                        Berdasarkan ketentuan Kode Etik Advokat Indonesia (KEAI)
                        serta Standar Kepatuhan Independensi Profesi Firma Hukum
                        Roni, Putra &amp; Kusumah (RPK Law Firm), telah
                        dilaksanakan penelusuran menyeluruh (
                        <em>Comprehensive Conflict of Interest Scan</em>)
                        terhadap basis data klien aktif, mantan klien, pihak
                        lawan (<em>adverse parties</em>), kuasa hukum lawan,
                        saksi, dan afiliasi perkara dengan rincian sebagai
                        berikut:
                    </p>
                    ...
                    <div className="overflow-hidden rounded-xl border border-slate-200/90 bg-slate-50/50 dark:border-white/10 dark:bg-[#121418]">
                        <div className="grid grid-cols-1 divide-y divide-slate-200 sm:grid-cols-2 sm:divide-x sm:divide-y-0 dark:divide-white/10">
                            ...
                            <div className="space-y-3 p-4">
                                <div>
                                    <span className="block text-[10px] font-bold tracking-wider text-slate-400 uppercase dark:text-zinc-500">
                    ...
                    conflictCheck.matches.length > 0 ? (
                        <div className="space-y-2.5">
                            <h3 className="text-xs font-bold tracking-wide text-slate-900 uppercase dark:text-white">
                            ...
                            <div className="overflow-x-auto rounded-xl border border-slate-200/90 dark:border-white/10">
                                <table className="w-full text-left text-xs">
                                    <thead className="border-b border-slate-200 bg-slate-900 text-[10.5px] font-bold tracking-wider text-white uppercase dark:bg-white dark:text-slate-900">
                                        <tr>
                                            <th className="p-3">
                                                Nama Entitas / Pihak
                                            </th>
                                                    ...
                                                    <td className="p-3 text-center">
                                                        <span
                                                            className={`rounded-md px-2 py-0.5 font-mono text-[10px] font-bold uppercase ${
                                                                match.risk ===
                                                                'blocked'
                                                                    ? 'border border-rose-200 bg-rose-50 text-rose-800 dark:bg-rose-950/50 dark:text-rose-300'
                                                                    : 'border border-amber-200 bg-amber-50 text-amber-800 dark:bg-amber-950/50 dark:text-amber-300'
                                                            }`}
                                                        >
                                                            {match.risk ===
                                                            'blocked'
                        ...
                        <div className="rounded-xl border border-slate-200/90 bg-slate-50/70 p-4 text-slate-800 dark:border-white/10 dark:bg-[#121418] dark:text-zinc-200">
                            <div className="flex items-center gap-2 font-bold text-slate-900 dark:text-white">
                                ...
                                <span>
                                    Hasil Penelusuran: Nihil Benturan
                                    Kepentingan (Zero Conflicts)
                                </span>
                            </div>
                            <p className="mt-1 text-xs leading-relaxed text-slate-600 dark:text-zinc-400">
                                ...
                                pihak lawan pada seluruh portofolio perkara yang
                                sedang atau pernah ditangani oleh RPK Law Firm.
                            </p>
                        </div>
                    )}
                    ...
                    {conflictCheck.decision_note && (
                        <div className="rounded-xl border border-slate-200/90 bg-slate-50/70 p-4 text-slate-800 dark:border-white/10 dark:bg-[#121418] dark:text-zinc-200">
                            <h4 className="text-[10.5px] font-bold tracking-wider text-slate-900 uppercase dark:text-white">
                                Catatan &amp; Justifikasi Etik Managing Partner:
                            </h4>
                            <p className="mt-1.5 text-xs leading-relaxed whitespace-pre-line text-slate-700 italic dark:text-zinc-300">
                                "{conflictCheck.decision_note}"
                            </p>
                ...
                <div className="mt-10 border-t border-slate-200/90 pt-6 dark:border-white/10">
                    <div className="flex flex-col justify-between gap-6 sm:flex-row sm:items-end">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="space-y-0.5">
                                    ...
                                    <p className="font-mono text-[10px]">
                                        ID: CC-RPK-
                                        {conflictCheck.id.slice(0, 14)}
                                    </p>
                                    <p className="text-[10px] text-slate-400">
                                        Diterbitkan resmi oleh Sistem Tata
                                        Kelola RPK Law Firm.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="min-w-[220px] space-y-1 text-center sm:text-right">
                            ...
                            <p className="text-[10px] text-slate-500 dark:text-zinc-400">
                                {conflictCheck.reviewer?.position_title ??
                                    'Managing Partner & Ethics Officer'}
                            </p>
                        </div>
                    </div>
                </div>
