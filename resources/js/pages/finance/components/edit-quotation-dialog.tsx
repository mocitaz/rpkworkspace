        ...
        if (quotation) {
            ...
            setValidUntil(
                quotation.valid_until
                    ? quotation.valid_until.substring(0, 10)
                    : '',
            );
            ...
            <DialogContent className={financeDialogPanelClass('wide')}>
                    ...
                    <div className="flex items-center gap-2.5">
                        ...
                        <div>
                            ...
                            <DialogDescription className="text-xs text-slate-500 dark:text-zinc-400">
                                Perbarui proposal honorarium advokat, ruang
                                lingkup jasa, dan estimasi biaya.
                            </DialogDescription>
                        </div>
                    </div>
                </DialogHeader>
                ...
                >
                    ...
                    <div className="grid gap-3 sm:grid-cols-2">
                        ...
                        {/* Breakdown Card */}
                        <div className="flex flex-col justify-between space-y-1.5 rounded-xl border border-amber-100 bg-amber-50/40 p-3 text-xs dark:border-amber-900/40 dark:bg-amber-950/20">
