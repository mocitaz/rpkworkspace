...
import { Banknote, Building2, Landmark, Shield, Users } from 'lucide-react';
    ...
    const accountTypes = [
        {
            ...
            desc: 'Rekening giro/tabungan firma',
            icon: Landmark,
        ...
        },
        {
            ...
            desc: 'Pos utang/piutang partner',
            icon: Users,
        ...
        },
        {
            ...
            desc: 'Rekening escrow/titipan perkara',
            icon: Shield,
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className={financeDialogPanelClass('default')}>
                <FinanceDialogHeader
                    ...
                    description="Buat rekening operasional, kas kecil, dana titipan, atau pos talangan partner."
                />
                            ...
                            {accountTypes.map((type) => {
                                ...
                                return (
                                    <button
                                        ...
                                        type="button"
                                        onClick={() =>
                                            form.setData('type', type.id as any)
                                        }
                                    ...
                                    >
                                        <div
                                            className={`mt-0.5 flex size-6 shrink-0 items-center justify-center rounded-md ${isSelected ? 'bg-blue-600 text-white' : 'bg-slate-100 dark:bg-white/10 ' + type.color}`}
                                        >
                                            <Icon className="size-3" />
                                        </div>
                                        <div className="min-w-0 flex-1">
                                            <p
                                                className={`text-xs font-semibold ${isSelected ? 'text-blue-900 dark:text-blue-200' : 'text-slate-800 dark:text-zinc-200'}`}
                                            >
                                                {type.label}
                                            </p>
                    ...
                    <div className="space-y-2.5 rounded-xl border border-slate-200/80 bg-slate-50/50 p-3 dark:border-white/[0.06] dark:bg-[#16181f]">
                        ...
                        <div>
                            ...
                            <MoneyInput
                                ...
                                onValueChange={(val) =>
                                    form.setData('opening_balance', val)
                                }
