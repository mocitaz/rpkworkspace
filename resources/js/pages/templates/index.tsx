...
export default function TemplatesIndex({
    ...
    const filteredTemplates = useMemo(() => {
        return templates.filter((tpl) => {
            ...
            const matchesType =
                selectedType === 'all' || tpl.document_type === selectedType;
                    ...
                    <div className="flex flex-col justify-between gap-4 border-b border-slate-200/60 pb-5 sm:flex-row sm:items-center dark:border-white/[0.06]">
                        <div className="space-y-1">
                            ...
                            <p className="text-xs text-slate-500 dark:text-zinc-400">
                                Standardisasi draf gugatan, surat kuasa, somasi,
                                dan kontrak bisnis dengan substitusi placeholder
                                dinamis.
                            </p>
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                        <div className="rounded-xl border border-slate-200/70 bg-white p-4 shadow-2xs dark:border-white/[0.06] dark:bg-[#14161b]">
                            ...
                            <p className="mt-0.5 text-[10px] text-slate-400">
                                Semua versi template terdaftar
                            </p>
                        </div>
                    ...
                    <div className="flex flex-col gap-3 rounded-xl border border-slate-200/70 bg-white p-3.5 shadow-2xs sm:flex-row sm:items-center sm:justify-between dark:border-white/[0.06] dark:bg-[#14161b]">
                        <div className="relative flex-1">
                            ...
                            <Input
                                ...
                                className="h-8 border-slate-200 bg-slate-50/60 pl-8 text-xs dark:border-white/10 dark:bg-[#121418]"
                            />
                        </div>
                    ...
                    {filteredTemplates.length ? (
                        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                            {filteredTemplates.map((tpl) => {
                                const placeholdersList: string[] =
                                    Array.isArray(tpl.placeholders)
                                        ? tpl.placeholders
                                        : tpl.placeholders
                                        ...
                                        <div className="space-y-2.5">
                                            <div className="flex items-center justify-between">
                                                ...
                                                <div className="flex items-center gap-1.5">
                                                    <span className="py-0.2 rounded bg-slate-100 px-1.5 font-mono text-[9px] font-bold text-slate-600 dark:bg-white/10 dark:text-zinc-300">
                                                        v{tpl.version}
                                                    </span>
                                                    {tpl.scan_status ===
                                                    'clean' ? (
                                                ...
                                                <div className="flex flex-wrap gap-1">
                                                    {placeholdersList
                                                        ...
                                                        .map((p, idx) => (
                                                            <span
                                                                key={idx}
                                                                className="py-0.2 rounded border border-slate-200/80 bg-slate-50 px-1.5 font-mono text-[9px] text-slate-600 dark:border-white/10 dark:bg-[#121418] dark:text-zinc-300"
                                                            >
                                                                {`{{${p}}}`}
                                                            </span>
                                                        ))}
                                                    {placeholdersList.length >
                                                        4 && (
                                                        <span className="py-0.2 rounded bg-slate-100 px-1.5 text-[9px] font-medium text-slate-500 dark:bg-white/5">
                                                            +
                                                            {placeholdersList.length -
                                                                4}{' '}
                                                            lainnya
                        ...
                        <div className="flex min-h-[260px] flex-col items-center justify-center rounded-xl border border-dashed border-slate-200 bg-white p-8 text-center dark:border-white/10 dark:bg-[#14161b]">
                            ...
                            <p className="mt-1 max-w-sm text-[11px] text-slate-400">
                                Unggah berkas Microsoft Word (.docx) dengan tag
                                placeholder seperti {'{{NAMA_KLIEN}}'} untuk
                                membuat generator dokumen otomatis.
                            </p>
                        </div>
                    )}
                </main>
                                    ...
                                    <div className="grid gap-3 sm:grid-cols-2">
                                        {placeholdersList.map((ph) => (
                                            ...
                                            >
                                                <Label
                                                    htmlFor={`ph_${ph}`}
                                                    className="font-mono text-[10.5px] font-bold text-blue-600 dark:text-blue-400"
                                                >
                                                    {`{{${ph}}}`}
                                                </Label>
                                                <Input
                ...
                <DialogHeader className="border-b border-slate-100 pb-3.5 dark:border-white/[0.06]">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <DialogDescription className="text-xs text-slate-500 dark:text-zinc-400">
                                Berkas Microsoft Word (.docx) dengan tag
