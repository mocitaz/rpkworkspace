    ...
    return (
        <Dialog open={!!user} onOpenChange={onOpenChange}>
            <DialogContent className="max-h-[90vh] overflow-y-auto rounded-2xl border border-slate-200/80 bg-white p-0 shadow-2xl sm:max-w-2xl dark:border-white/10 dark:bg-[#14161b]">
                ...
                <div className="border-b border-slate-100 bg-slate-50/60 p-5 sm:p-6 dark:border-white/[0.06] dark:bg-[#121418]">
                    <div className="flex items-center justify-between gap-3">
                        <div className="flex items-center gap-3.5">
                            <div className="relative size-12 shrink-0 rounded-xl bg-linear-to-b from-slate-200 via-slate-100 to-slate-300 p-0.5 shadow-xs dark:from-white/20 dark:via-white/5 dark:to-white/15">
                                <Avatar className="size-full rounded-[10px] bg-slate-900 shadow-inner dark:bg-zinc-800">
                                    <AvatarImage
                                        src={user.avatar_url ?? undefined}
                                        className="object-cover"
                                    />
                                    <AvatarFallback className="rounded-[10px] bg-linear-to-br from-slate-900 via-slate-800 to-indigo-950 text-sm font-bold text-white">
                                        {getInitials(user.name)}
                                    </AvatarFallback>
                                </Avatar>
                            </div>
                            <div className="min-w-0">
                                <DialogTitle className="truncate text-base font-bold text-slate-900 sm:text-lg dark:text-white">
                        ...
                        <span className="hidden shrink-0 items-center rounded-md border border-slate-200/80 bg-white px-2.5 py-1 font-mono text-[11px] font-bold text-slate-800 shadow-2xs sm:inline-flex dark:border-white/10 dark:bg-zinc-800 dark:text-zinc-200">
                            {user.employee_code ||
                                `RPK-${user.id.toString().padStart(3, '0')}`}
                        </span>
                    </div>
                    ...
                    <div className="mt-4 grid grid-cols-2 gap-1 rounded-xl border border-slate-200/70 bg-slate-100/80 p-1 sm:grid-cols-4 dark:border-white/5 dark:bg-[#181a20]">
                        <button
                            type="button"
                        ...
                        <>
                            ...
                            {activeTab === 'account' && (
                                <div className="space-y-4">
                                    ...
                                    {/* Role Selection Grid */}
                                    <div className="space-y-2.5 rounded-2xl border border-slate-200/80 bg-slate-50/50 p-4 dark:border-white/[0.06] dark:bg-[#121418]">
                                        <div className="flex items-center justify-between">
                                        ...
                                        <div className="grid grid-cols-1 gap-2 pt-1 sm:grid-cols-2">
                                            {roles.map((role) => {
                                                ...
                                                return (
                                                    <label
                                                        key={role.id}
                                                        className="flex cursor-pointer items-center justify-between rounded-xl border border-slate-200/80 bg-white p-2.5 shadow-2xs transition-all hover:border-slate-300 hover:bg-slate-50/80 dark:border-white/10 dark:bg-[#16181d] dark:hover:border-white/20"
                                                    >
                                                        <div className="flex items-center gap-2.5">
                                                            <input
                                                                type="checkbox"
                                    ...
                                    {/* Status Card */}
                                    <label className="flex cursor-pointer items-center justify-between rounded-2xl border border-slate-200/80 bg-slate-50/70 p-3.5 transition-colors hover:bg-slate-100/70 dark:border-white/10 dark:bg-[#16181d] dark:hover:bg-white/[0.04]">
                                        <div className="flex items-center gap-3">
                                            <div className="flex size-8.5 items-center justify-center rounded-xl bg-emerald-50 text-emerald-600 dark:bg-emerald-950/50 dark:text-emerald-400">
                                        ...
                                        <input
                                            ...
                                            className="size-4.5 rounded border-slate-300 text-emerald-600 focus:ring-emerald-500 dark:border-white/20 dark:bg-zinc-800"
                                        />
                                    </label>
                                </div>
                            )}
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                                        <Field
                                            ...
                                            helperText="Sistem otomatis memantau masa aktif KTA"
                                        />
                                        <div className="flex flex-col justify-center rounded-xl border border-dashed border-slate-200/80 bg-slate-50/50 p-3 dark:border-white/10 dark:bg-white/[0.02]">
                                            <div className="flex items-center gap-1.5 text-xs font-semibold text-slate-700 dark:text-zinc-300">
                                                ...
                                                <span>
                                                    Pengingat Legalitas KTA
                                                </span>
                                            </div>
                                            <p className="mt-1 text-[11px] leading-relaxed text-slate-500 dark:text-zinc-400">
                                                Notifikasi otomatis akan muncul
                                                60 hari sebelum KTA kadaluwarsa.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div className="space-y-4">
                                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                                        ...
                                        <div className="flex flex-col justify-center rounded-xl border border-dashed border-slate-200/80 bg-slate-50/50 p-3 dark:border-white/10 dark:bg-white/[0.02]">
                                            ...
                                            <p className="mt-1 text-[11px] leading-relaxed text-slate-500 dark:text-zinc-400">
                                                NPWP digunakan untuk bukti
                                                potong pajak honorarium &amp;
                                                payroll.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-3 rounded-2xl border border-slate-200/80 bg-slate-50/50 p-4 dark:border-white/[0.06] dark:bg-[#121418]">
                                        <div className="flex items-center gap-1.5">
                            ...
                            <div className="flex items-center justify-between border-t border-slate-100 pt-4 dark:border-white/[0.06]">
                                <Button
                                    ...
                                    className="h-9 cursor-pointer rounded-xl px-3.5 text-xs font-semibold text-rose-600 hover:bg-rose-50 hover:text-rose-700 dark:text-rose-400 dark:hover:bg-rose-950/30"
                                >
                                ...
                                <div className="flex items-center gap-2">
                                    <Button
                                        ...
                                        className="h-9 rounded-xl border-slate-200/80 px-4 text-xs font-semibold text-slate-700 shadow-2xs hover:bg-slate-50 dark:border-white/10 dark:bg-[#16181d] dark:text-zinc-300"
                                    >
                                        Batal
                                    </Button>
                                    <Button
                                        size="sm"
                                        disabled={processing}
                                        className="h-9 cursor-pointer rounded-xl bg-slate-900 px-5 text-xs font-semibold text-white shadow-sm hover:bg-slate-800 active:scale-95 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-100"
                                    >
                                        {processing ? (
                                            <>
