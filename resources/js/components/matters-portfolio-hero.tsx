...
export function MattersPortfolioHero({
    ...
    return (
        <section className="group relative flex min-h-[250px] flex-col justify-between overflow-hidden rounded-[20px] border border-slate-200/80 bg-gradient-to-br from-[#f7f9ff] via-white to-[#eaf3ff] px-6 py-6 shadow-[0_10px_28px_rgba(71,85,105,0.075)] sm:h-[250px] sm:px-8 dark:border-white/[0.08] dark:from-[#17191f] dark:via-[#17191f] dark:to-[#18202b]">
            ...
            <div className="matters-hero-dots pointer-events-none absolute inset-y-0 right-0 hidden w-[440px] [background-image:radial-gradient(rgba(59,130,246,0.24)_1px,transparent_1px)] [mask-image:linear-gradient(to_right,transparent,black_28%)] [background-size:18px_18px] opacity-30 md:block" />
            <svg
                viewBox="0 0 560 250"
                aria-hidden="true"
            ...
            <div className="matters-hero-lawyer pointer-events-none absolute right-0 bottom-0 hidden h-[230px] w-[440px] overflow-hidden md:block">
                <img
